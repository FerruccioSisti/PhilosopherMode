...
class DraftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create draft" do
    assert_difference('Draft.count') do
      post drafts_url, params: { draft: { dire: @draft.dire, radiant: @draft.radiant, user_id: @draft.user_id } }
    end
  ...
  test "should update draft" do
    patch draft_url(@draft), params: { draft: { dire: @draft.dire, radiant: @draft.radiant, user_id: @draft.user_id } }
